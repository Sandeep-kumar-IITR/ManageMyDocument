...
//     const token = user.access; // Replace with your actual token
//     // Assuming item has an id property
//     const id = item.id; // Get the id of the item to be deleted

//     try {
//       const response = await fetch(`http://127.0.0.1:8000/ap/delete/${id}/`, {
//         method: 'DELETE',
//         headers: {
...
//         // setDeleteid(-1); // Reset deleteid after deletion
//       } else {
...
export default function DocCard({ item }) {
  ...
  const { deleteid, setDeleteid, user, createdoc, setCreatedoc } = useContext(UserContext);
